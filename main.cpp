...
int main(int argc, char** argv) {
	{//just dumping the 2d scene (yay we have enough dimensions!)
		...
		//screen line
		line(Vec2i(10, 10), Vec2i(790, 10), scene, red);
	...
	}
	{
		...
		rasterize(Vec2i(120, 434), Vec2i(744, 400), render, green, ybuffer);
		rasterize(Vec2i(330, 463), Vec2i(594, 200), render, blue, ybuffer);

		//1-pixel wide image is bad for eyes,lets width it
		for (int i = 0; i < width; i++) {
			for (int j = i; j < 16; j++) {
